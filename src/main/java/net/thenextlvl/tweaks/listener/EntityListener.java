...
public class EntityListener implements Listener {
    ...
    public void onAnimalBreed(PlayerInteractEntityEvent event) {
        if (!plugin.getTweaksConfig().vanillaTweaks().animalHealByFeeding()) return;
    ...
    public void onSheepWoolRegrow(SheepRegrowWoolEvent event) {
        var cooldown = plugin.getTweaksConfig().vanillaTweaks().sheepWoolGrowthCooldown();
    ...
    public void onCowMilk(PlayerInteractEntityEvent event) {
        ...
        var cooldown = plugin.getTweaksConfig().vanillaTweaks().cowMilkingCooldown();
